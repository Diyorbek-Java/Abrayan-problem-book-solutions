...
public class Solution37 {
    public static void main(String[] args) {
        ...
        System.out.println("Solution is for finding the distance between Two cars Considering that distance is decreasing");
        ...
        double distanceAfter =currentDistance - ((speedCar1 + speedCar2) * time) ;

...
public class Solution099 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                Given an array of N integers, remove all elements whose values appear less than twice in the array.
        ...
        arrayA = removeMoreThanTwice(arrayA);
        System.out.printf("The worked array size is %d and Elements are ", arrayA.length);
        System.out.println(Arrays.toString(arrayA));
    }

    public static int[] removeMoreThanTwice(int[] array) {
        Arrays.sort(array);

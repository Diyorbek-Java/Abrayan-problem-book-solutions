...
public class Solution093 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                Given an array of N (> 2) integers, remove all elements with even order numbers (2, 4, …)
        ...
        arrayA = removeEvenOrderNumbers(arrayA);
        System.out.printf("The worked array size is %d and Elements are ", arrayA.length);
        System.out.println(Arrays.toString(arrayA));
    }

    public static int[] removeEvenOrderNumbers(int[] array) {
        int counter = 0;

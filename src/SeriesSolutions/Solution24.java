...
public class Solution24 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                ...
                Output the sum of the values of elements placed between two last zero-valued elements.
                If two last zero-valued elements are placed side by side then output 0.
                """);
        ...
        System.out.println("the sum of the values of elements is: " + sum);
        scanner.close();
    }
}

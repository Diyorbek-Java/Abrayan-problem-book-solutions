...
public class Solution129 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                Given an array of N integers, increase its last series of the maximal length by one element (see the series definition in Array116).
                """);
        ...
        int[] result = increaseLastMaxSeries(arrayA);
    ...
    public static int[] increaseLastMaxSeries(int[] A) {

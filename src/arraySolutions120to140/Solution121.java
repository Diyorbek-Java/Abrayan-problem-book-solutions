...
public class Solution121 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                An integer K (> 0) and an array of N integers are given. Double the length of the K-th series of equal
                numbers of the array (see the series definition in Array116). If the array contains less than K series then do not change it.
                """);

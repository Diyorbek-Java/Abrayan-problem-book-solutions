...
public class Solution125 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                An integer L (> 1) and an array of N integers are given. Replace each series, whose length is less than L,
                by one element with zero value (see the series definition in Array116).
                """);
        ...
        int[] result = replaceSeries(arrayA, k);
